...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  UpdateParcelStatus(String ParcelRecieved) {
    _status.value = ParcelRecieved;
  }
  ...
  updateStatusValueInDatabase() async {
    try {
      var response = await http.post(Uri.parse(API.updateOrder), body: {
          ...
          child: Column(
            ...
            children: [
              ...
              FadeInImage(
                ...
                image: NetworkImage(
                  API.hostImage + widget.clickedOrderInfo!.image!,
                ),
